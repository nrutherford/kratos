...
func main() {
    ...
    submitSelfServiceVerificationFlowBody := openapiclient.submitSelfServiceVerificationFlowBody{SubmitSelfServiceVerificationFlowWithCodeMethodBody: openapiclient.NewSubmitSelfServiceVerificationFlowWithCodeMethodBody("Email_example", "Method_example")} // SubmitSelfServiceVerificationFlowBody | 

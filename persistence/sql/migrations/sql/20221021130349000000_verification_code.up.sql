...
(
    ...
    CONSTRAINT identity_verification_codes_identity_verifiable_addresses_id_fk
        ...
        ON DELETE cascade,
    CONSTRAINT identity_verification_codes_selfservice_verification_flows_id_fk
        FOREIGN KEY (selfservice_verification_flow_id)
        REFERENCES selfservice_verification_flows (id)
        ON DELETE cascade,
    CONSTRAINT identity_verification_codes_identity_id_fk
        FOREIGN KEY (identity_id)
        REFERENCES identities (id)
        ON UPDATE RESTRICT ON DELETE CASCADE,
    CONSTRAINT identity_verification_codes_networks_id_fk
        FOREIGN KEY (nid)
...
ALTER TABLE selfservice_verification_flows ADD submit_count int NOT NULL DEFAULT 0;
